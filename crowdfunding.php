...
<meta name="viewport" content="width=device-width">
	<meta name="og:image" content="https://www.bjhs.org/wp-content/uploads/2023/05/Image.jpeg" >
...
<section class="jumbotron text-center">
  ...
  <video id="video-background" preload muted autoplay loop>
    <source src="img/crowdfunding23.mp4" type="video/mp4">
  </video></a>
	</section>
<!--
...
-->
	...
	<div class="container">
		<div class="row">
			...
			<h1>Partner with Beth Jacob High School of Denver and enable our students to continue


	<br>
<span class="headline-big">Thriving. Learning. Growing.</span>
</h1>
<!--
		<h3>Partner with Beth Jacob High School of Denver<br>
...
Beth Jacob High School is registered as a 501(c)3 organization and donations / contributions are tax-deductible to the extent of the law.
  ...
  <div class="panel panel-default">
    ...
    <div id="collapse1" class="panel-collapse collapse">
      <div class="panel-body">Now, more than ever is the time for us to support their Thriving. Learning. Growing. <br><br>
...
Please partner with Bais Yaakov of Denver today.<br>
Your donation will enable them to continue Thriving. Learning. Growing.<br><br>
...
<div class="row" style="padding-top:20px;" id="divmonthlyoptions">
		...
		<div class="col-md-6" align="center"><button type="button" id="donateonce" class="btn btn-default btn-bloc btn-donate-type" value="once">ONE TIME DONATION</button></div>
