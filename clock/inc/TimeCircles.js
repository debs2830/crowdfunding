    ...
    TC_Instance.prototype.initialize = function(clear_listeners) {
		...
		/*var timetext='';
		   for (var key in this.data.text_elements) {
			   if (Math.round(this.config.number_size * this.data.attributes.item_size) > 0 ){
			   timetext += this.config.time[key].text+ ":" + Math.round(this.config.number_size * this.data.attributes.item_size+ ' ');
			   }
