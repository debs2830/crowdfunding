...
<link rel="stylesheet" href="css/normalize.min.css"><link rel="stylesheet" href="https://cdn.datatables.net/1.10.16/css/jquery.dataTables.min.css">
  ...
  $("#datatables").table2excel({
    ...
    filename: "crowdFundingList" //do not include extension
  }); 
...
echo '<IMG SRC="http://www.bjhs.org/wp-content/uploads/2017/11/by2017parlor.jpg" ALT="Dinner" style="width:200px;" >';
		...
		<?php if ($_GET['eventid'] == 2 )			 {?>
			<div align="center">		
				<h2>Shas Campaign</h2></div><?php } ?>
        <div><button id='export' >Download Database as Excel</button> 
		...
		}		elseif ($_GET['eventid'] ==5 || $_GET['eventid'] ==16) {
				 $url = "editLuncheon.php?id=".$row['tnxid']."&eventid=".$_GET['eventid'];
		}
