...
<title>Shas Legacy Campgaign</title>
	  ...
	  <table>
			<tr style="vertical-align: text-bottom;">
				...
				<td valign="top" style="vertical-align: text-bottom;">
					...
					<img src="/wp-content/uploads/2018/04/shasbanner.jpg" width="752" height="322">
                  </div>
				</td>
				</tr>
				<tr>
...
?>
			...
			<br /> <label for="phone">Phone Number</label>: <br /> <input
				...
				id="email" name="email" required value="<? echo $_SESSION['post_data']['email'] ?>" /> 
                  <input id="search" type="hidden" style="padding:2px;font-size:.6em;width:300px;" /><div style="margin:20px 0 0 0;"> <span id="results" style="color:#68a;"></span> <br /> <br /> 
				<br />
				<br />
...
<td width="245" style="vertical-align: text-top;">
	 If you would like to dedicate a particular Seder/Krach/Masechta/Perek/Daf, please write your preference below. 
	<input type="text" name="amtdescr" >
  </td>
</tr>
		...
		if ($_SESSION['post_data']['otheramt'] != "" ) {
			...
			echo "0"; } ?>"/>
			   ...
			   <label for="totaldue">Total Amount Due: $ </label>   <input
				type="text" style="width: 90px" id="totaldue" name="totaldue"  required="required"	 value="<? echo $_SESSION['post_data']['totaldue'] ?>" <? if ( $_GET['mode'] != "adminxx" ) {?>readonly <? }?>/><br>
...
<? if ( $_GET['mode'] == "adminxx" ) {?>
		  ...
		  <div id="ccinfo" style="display:none">
			...
			<select
				name="cc" id="cc" style="width: 125px">
...
?>
	   ...
	   <input type="hidden" name="eventid" id="eventid" value="2"></input>
       	   <input type="hidden" name="description" id="eventid" value="Shas Campaign"></input>
