...
$thermometer=[];
$thermometerTotal=[];
$thermometerTotalPeople=[];
$thermometerGoal=[];
$thermometerPeopleGoal=[];
$thermometerLink=[];
...
<meta name="description"
	content="BJHS - Triple Your Donation Campaign" />
...
<meta name="viewport" content="width=device-width">
	...
	<meta name="og:title" content="BJHS - Triple Your Donation Campaign" >
	<meta name="og:description" content="Every dollar donated to the Beth Jacob for the next 30 hours – until 6 pm on Wednesday - will be Tripled by generous matchers. " >
...
<section class="jumbotron text-center">
  ...
  <video id="video-background" preload muted autoplay loop>
    <source src="img/crowdfunding22.mp4" type="video/mp4">
  </video></a>
	</section>
<!--
...
-->
	...
	<div class="container">
		<div class="row">
			...
			<h1>PARTNER WITH BETH JACOB HIGH SCHOOL OF DENVER TO 


	<br>
<span class="headline-big">INSPIRE GREATNESS IN JEWISH WOMEN OF TOMORROW</span>
</h1>
...
<div id="content " >	
	<div class="donatebox timer col-xs-12" >
		 <link rel="stylesheet" href="/events/clock/inc/TimeCircles.css" />
            <div id="DateCountdown" data-date="2023-05-17 18:00:00" style=" padding: 0px; box-sizing: border-box; background-color: #E0E8EF"></div>
		
<div id="totalprogress"></div>
		<div class="goaltotal">Goal: $<?php   echo  number_format($initialgoal, 0);;?> </div>
		<div class="bonusmessage2" style="font-size: 1.2em;font-weight: bold; display: none;padding-bottom: 20px;" >
BONUS GOAL: $<?php echo number_format($secondgoal,0);?>
...
<?php } else   { ?>
    ...
    while($row = $result->fetch_assoc()) {
		...
		$thermometerTotalPeople[$row['ID']] += 1;
	
        $output.= "<li data-nickname='" . $row["nickname"]."' ";
		if (isset($teamid) && $row["ID"] !=$teamid) { 
		$output.= " class='hidden' ";
		}
			$output.= ">". $row["names1"]. " <span class='rtamt' style='font-weight:bold;'>  $" . ($row["amtpayed"]* $amttotimesby). "</span><small >";
		if ( $row["adcomment"]) {
...
<div class="innertext" id="sponsor-box">
		<div class="sponsorinfo " >
	      <div class="donatebox donateboxtop" style="">
			  <div class="col-md-12 divdouble"><label style="font-size:1.1em;">Every dollar donated is <span class="bonusmessage" style="display: none">STILL </span>  <span id="wordsduplicated">Tripled!</span></label></div>
			    <div class="row">
				  	 <div class="col-md-12" style="clear: both;">
<!--			  <div class="col-md-12">OR</div>
			  <label for="totaldue">Other Donation  </label> 
			  <input
    ...
    <div class="col-md-8 col-md-offset-2" >
			<button id="donatebtn" class="btn btn-primary btn-lg" data-type='cc' ><i class="fa fa-credit-card"></i>  DONATE  </button>
			   <p><i>Or click on one of the boxes below</i></p>
			</div>
			  ...
			  <div class="outsideboxes">
				  ...
				  <div class="col-sm-4 col-xs-12 insideboxes"><div class="panel panel-default donate-sponsor" data-type="sponsorship" data-totalamt="120">
					  <div class="col-xs-4 sponsor-image"><img src="/events/img/logo.gif" alt="Beth Jacob High School of Denver" /></div>
...
OR $100 x 12 </div>
				  ...
				  <div class="col-sm-4 col-xs-12 insideboxes"><div class="panel panel-default donate-sponsor" data-type="sponsorship" data-totalamt="1800">
					  <div class="col-xs-4 sponsor-image"><img src="/events/img/logo.gif" alt="Beth Jacob High School of Denver" /></div>
					  <div class="col-xs-8 sponsor-text"><div class="panel-heading">Gold </div>
...
Beth Jacob High School is registered as a 501(c)3 organization and donations / contributions are tax-deductible to the extent of the law.
  ...
  <div class="panel panel-default">
    ...
    <div id="collapse1" class="panel-collapse collapse">
      <div class="panel-body">Now, more than ever is the time to <strong>inspire greatness</strong> in future Jewish leaders <strong>one step at a time</strong>.<br>
<br>
Since 1968, Beth Jacob High School of Denver has offered a program of excellence in Jewish and general studies, and an indelible experience that empowers young women to encounter their future.
<br><br>

Bais Yaakov graduates emerge as proud, confident women, builders of Jewish families and communities.
<br><br>
Please partner with Bais Yaakov of Denver today. 
<br><br>
Your donation will:
<br>
		  <ul>

<li>Provide a scholarship for a student 
</li><li>        Enhance school ruach </li>
<li>         Facilitate upgrading technology standards </li>
<li>         Inspire greatness in future Jewish leaders </li>

</ul>

<strong>Triple your Gift:</strong><br>
Your donation goes three times farther with this Crowdfunding Campaign. For every $1 you donate, our matching donors will give an additional $2.
<br><br>
$18 becomes $54!<br>
$100 becomes $300!<br>
$180 becomes $540!<br>
$1,000 becomes $3,000!<br>
$1,800 becomes $5,400!<br><br>
...
Bryan & Dr. Susan Schiff<br>
  ...
  <div id="teams">
	  ...
	  <?php
		 ...
		 // 
		  ...
		  foreach ($thermometerTotal as $key => $value) {
		   ...
		   if ($thermometerGoal[$key] !='')  {
			  echo '<li class="col-xs-12 col-sm-6"><span class="col-xs-12 teambox" data-id="'.$key.'">';
        ...
        <div class="track">
            <div class="goal">
			  ...
			  echo '</strong><br>of ';
			   ...
			   echo ' raised</div>';
			   		   echo  '<div style="clear:both; " class="teamthermodiv" >
			    <div id="thermoPeople_'.$key.'" class="thermometer horizontal goal_people" align="center">
        ...
        <div class="track">
            <div class="goal">
			   ...
			   if ($thermometerPeopleGoal[$key]> 0 ) { 
			   echo '<div class="teamgoalpeople" style="clear:both">(<strong>';
			      echo  $thermometerTotalPeople[$key];
			
			  echo ' donor';
			   echo plural($thermometerTotalPeople[$key]);
			   echo '</strong> of ';
			  
			   echo  number_format($thermometerPeopleGoal[$key], 0);
				   echo ' donor';
			   echo plural($thermometerPeopleGoal[$key]);
			   echo')</div>';
			  	}//end has people goal
			  }
	...
	<span class="teamid hidden"><?php echo $teamid;?></span>
		<!-- <div class="sponsorinfo" >
	      <div class="donatebox" style=""><label>Every dollar donated is Tripled!</label><br><label for="totaldue">Donation Amount:  </label>  <input
...
-->
		  ...
		  <form action="/events/receiptDonation.php" method="post" id="form" name="form"  novalidate autocomplete="off" style="width: 100%">			
			  <div class="copysponsorinfo donatebox" ><label for="totaldue">Donation Amount:  </label>  <input
				type="number" style="width: 90px" id="totaldue" name="totaldue"  class="totaldue" required	 /> x<span id="amtduplicated" >3</span> <span></span><span id="newtotal"></span></div>
...
<div class="row" style="padding-top:20px;" id="divmonthlyoptions">
	...
	<input type="hidden" id="is-sponsor" name="" value="0">
		</div>
		<div id="monthlyCharges" style="display: none; margin-top:10px;">	
		    <div class="form-group">
			
			  <label for="duration">Duration (in months):</label>
			<input class="form-control" type="number"
				id="duration" name="duration" autofocus
				required="required" min="2" max="12" value="12" /> 
		</div>
			<div id="donatemonthlyAmount" style="margin-bottom: 15px;
font-size: 18px;
padding-left: 10px;"></div>
    ...
    <div id="ccinfo" >
		...
		<div class="form-group">
			<label for="lastname" style="z-index: 1000">Other Name to display or Anonymous :</label>
		<input type="text"
		...
		<div class="form-group">
			...
			<input type="text"
				...
				id="phone" name="phone"  required value=""  class="form-control"  pattern="^[0-9-+s()]*$"  autocomplete="tel"/> 
...
<div class="modal-header">   <button type="button" class="close" data-dismiss="modal" aria-label="Close">
      ...
      <div class="modal-body">
        <video width="100%" height="auto" src="/events/img/crowdfunding22.mp4" controls="controls" preload="auto"></video>
...
$(document).ready(function(){
	...
	foreach ($thermometerGoal as $key => $value) {
		...
		if ($value != 0) {
		echo 'thermometer("thermoTeam_'.$key.'", "';
		echo $value;
	echo  '", "';
	...
	foreach ($thermometerPeopleGoal as $key => $value) {
	
		if ($value != 0) {
		echo 'thermometer("thermoPeople_'.$key.'", "';
		echo $value;
	echo  '", "';
		echo $thermometerTotalPeople[$key];
			echo '",0);';
			} else {
			echo '$("#thermoPeople_'.$key.' .track").remove();$("#thermoPeople_'.$key.'").removeClass("thermometer").css("padding-top","50px"); ';
		}
	}
